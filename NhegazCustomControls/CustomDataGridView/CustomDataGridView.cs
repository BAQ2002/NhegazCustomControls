    ...
    public partial class CustomDataGridView : CustomControlWithHeader
    {
        ...
        protected override void AdjustControlSize()
        {
            ...
            {        
                ...
                AdjustInnerSizes(col, width, itemHeight); //Ajusta o tamaho 
                AdjustInnerLocations(col, headerX, y); //Ajusta a posicao
            ...
            for (int row = 0; row < NumberOfRows; row++)
            {
                ...
                for (int col = 0; col < NumberOfColumns; col++)
                {
                    ...
                    AdjustInnerSizes(row, col, width, itemHeight); //Ajusta o tamaho 
                    AdjustInnerLocations(row, col, x, y); //Ajusta a posicao
